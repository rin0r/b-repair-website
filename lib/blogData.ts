...
export const articles: Article[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "Professionelles Mikrolöten erfordert ein Präzisionsmikroskop mit bis zu 100-facher Vergrösserung, eine Heissluft-Reworkstation, hochpräzise Lötkolben mit Feinspitzen, ESD-sicheres Werkzeug und vor allem: jahrelange Erfahrung sowie eine IPC-Zertifizierung. Beides haben wir." },
      { type: "h2", text: "Warum bieten so wenige Shops Mikrolöten an?" },
      { type: "p", text: "Die Ausrüstung ist kostspielig, die Ausbildung langwierig und die Fehlertoleranz extrem gering. Ein falscher Handgriff unter dem Mikroskop kann eine Platine dauerhaft zerstören. Deshalb lehnen die meisten Shops solche Geräte einfach ab. Bei B-repair ist Mikrolöten unser Spezialgebiet – seit 2021 IPC-zertifiziert." },
